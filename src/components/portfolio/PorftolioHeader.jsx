const skills = ["React", "JavaScript", "HTML/CSS", "C#", ".NET"];
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="rounded-full bg-[#287271] px-3 py-1 text-sm text-white"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-48 w-48 items-center justify-center rounded-full bg-white/30">
              <span className="text-sm text-[#003049]">Your Photo Here</span>
            </div>
            <p className="font-medium text-[#003049]">Future Developer</p>
          </div>
        </div>
      </div>
    </section>
